...
import dd.surfit.test.applicationdemo.SlideMenu.example.anim.CustomScaleAnimation;
import dd.surfit.test.applicationdemo.SlideMenu.example.anim.CustomSlideAnimation;
import dd.surfit.test.applicationdemo.SlideMenu.example.anim.CustomZoomAnimation;
import dd.surfit.test.applicationdemo.SlideMenu.example.fragments.FragmentChangeActivity;
import dd.surfit.test.applicationdemo.SlideMenu.example.fragments.ResponsiveUIActivity;
