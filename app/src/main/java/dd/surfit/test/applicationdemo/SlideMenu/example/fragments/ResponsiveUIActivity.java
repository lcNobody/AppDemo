package dd.surfit.test.applicationdemo.SlideMenu.example.fragments;
...
import dd.surfit.test.applicationdemo.SlideMenu.example.lib.app.SlidingFragmentActivity;
